...
- 4 indicateurs clés (KPI) : élèves inscrits, pré-inscrits pour l'année suivante,
  nouvelles inscriptions du mois, élèves utilisant le transport.
...
│   └── excel_controller.py      # Import / Export Excel
├── views/
│   ├── dashboard_view.py
...
├── sample_data/
│   ├── eleves_exemple.xlsx       # Fichier Excel d'exemple (30 élèves)
│   └── template_eleves_vide.xlsx # Modèle Excel vide
├── exports/                     # Fiches élèves imprimées (HTML)
└── backups/                      # Sauvegardes de la base de données
```

---

## 📋 Colonnes du fichier Excel d'import / export
