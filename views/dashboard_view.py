...
class DashboardView(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        charts_frame.pack(fill="both", expand=True, padx=25, pady=(10, 20))
        charts_frame.grid_columnconfigure((0, 1, 2), weight=1, uniform="chart")
        charts_frame.grid_rowconfigure((0, 1), weight=1, uniform="chartrow")
    ...
    def refresh(self, update_year_settings: bool = True):
        ...
        months = sorted(set(m for m, _ in Student.get_monthly_registrations(self.selected_year)))
